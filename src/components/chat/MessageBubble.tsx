...
const SYSTEM_CONFIG: Record<string, {
  ...
  BRANCH_CONFIRMED:  { icon: Building2,       label: 'Pris en charge agence',  color: '#60a5fa',  bg: 'rgba(96, 165, 250, 0.10)', border: 'rgba(96, 165, 250, 0.30)' },
  BRANCH_COMPLETED:  { icon: CheckCheck,      label: 'Finalisé par l\'agence', color: '#4ade80',  bg: 'rgba(74, 222, 128, 0.15)', border: 'rgba(74, 222, 128, 0.35)' },
}

/**
 * Extrait le ref_ticket depuis le content "Ticket proposé: FX-000108"
 */
...
export function MessageBubble({ message }: Props) {
  ...
  // ─── Message système (ticket created/accepted/declined/expired/branch_*) ──
    ...
    return (
        <div className="flex justify-center py-1">
          ...
          >
            ...
            {ref && (
                <span
                    className="text-[10px] font-mono-nums font-bold px-1.5 py-0.5 rounded"
                    style={{
